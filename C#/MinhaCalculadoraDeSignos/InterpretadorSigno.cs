...
namespace MinhaCalculadoraDeSignos
{
    class InterpretadorSigno
    {
        ...
        public InterpretadorSigno()
        {
            ...
            signos[1] = new Signo { diaInicio = 19, mesInicio = 2, diaFim = 20, mesFim = 3, nome = "Peixes", caracteristicas = "Peixes nos ensina a fe, a conexao com uma dimensao superior, a simplicidade, o desprendimento a entrega a vida.Aceitacao e a palavra de Peixes." };
